...
var COLUMNS = ["Video Title", "Description", "Video Length", "Aspect Ratio", "Status", "Progress", "Approval Status", "Upload Status", "YouTube Status", "Last Updated", "Video URL", "Failure Reason"];
